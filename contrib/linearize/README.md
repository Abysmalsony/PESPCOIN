# Linearize
Construct a linear, no-fork, best version of the PESPCOIN blockchain. The scripts
run using Python 3 but are compatible with Python 2.

## Step 0: Install PESPCOIN_hash

https://github.com/PESPCOIN/PESPCOIN_hash
...
JSON-RPC server. Running `PESPCOINd` or `PESPCOIN-qt -server` will be sufficient.
...
* `input`: PESPCOINd blocks/ directory containing blkNNNNN.dat
