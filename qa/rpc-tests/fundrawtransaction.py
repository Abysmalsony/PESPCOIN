...
class RawTransactionsTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid PESPCOIN address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid PESPCOIN address" in e.error['message'])
