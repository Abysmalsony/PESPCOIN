...
void CNode::copyStats(CNodeStats &stats)
{
    ...
    // Raw ping time is in microseconds, but show it to user as whole seconds (PESPCOIN users should be well used to small numbers with many decimal places by now :)
...
void CConnman::ThreadSocketHandler()
{
    ...
    while (!interruptNet)
    {
        ...
        //
        {
            ...
            {
//                if (pnode->fDisconnect && (pindexBestHeader->nHeight > 1000))
...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        std::string strDesc = "PESPCOIN Core " + FormatFullVersion();
