    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = tr("Usage:") + "\n" +
            "  PESPCOIN-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the PESPCOIN in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 PESP, 0.1 PESP, 1 PESP and 10 PESP -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://PESPCOIN.atlassian.net/wiki/display/DOC/PrivateSend\">https://PESPCOIN.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
