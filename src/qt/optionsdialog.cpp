    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("PESP-light"), QVariant("light"));
//    ui->theme->addItem(QString("PESP-light-hires"), QVariant("light-hires"));
//    ui->theme->addItem(QString("PESP-light-retro"), QVariant("light-retro"));
//    ui->theme->addItem(QString("PESP-light-hires-retro"), QVariant("light-hires-retro"));
//    ui->theme->addItem(QString("PESP-blue"), QVariant("drkblue"));
//    ui->theme->addItem(QString("PESP-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("PESP-traditional"), QVariant("trad"));
