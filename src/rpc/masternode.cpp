...
UniValue masternodelist(const JSONRPCRequest& request)
{
                ...
                strMode != "rank" && strMode != "sentinel" && strMode != "status"))
    {
        throw std::runtime_error(
                ...
                "  payee          - Print PESPCOIN address associated with a masternode (can be additionally filtered,\n"
                "                   partial match)\n"
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "PESPCOIN",               "masternode",             &masternode,             true,  {} },
    { "PESPCOIN",               "masternodelist",         &masternodelist,         true,  {} },
    { "PESPCOIN",               "masternodebroadcast",    &masternodebroadcast,    true,  {} },
    { "PESPCOIN",               "getpoolinfo",            &getpoolinfo,            true,  {} },
    { "PESPCOIN",               "sentinelping",           &sentinelping,           true,  {} },
#ifdef ENABLE_WALLET
    { "PESPCOIN",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
