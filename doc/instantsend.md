...
This mechanism has been integrated into Bitcore-Node-PESPCOIN which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/PESPCOIN/insight-api-PESPCOIN#web-socket-api](https://github.com/PESPCOIN/insight-api-PESPCOIN#web-socket-api)
* API: [https://github.com/PESPCOIN/insight-api-PESPCOIN#instantsend-transactions](https://github.com/PESPCOIN/insight-api-PESPCOIN#instantsend-transactions)
...
By default, the PESPCOIN Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the PESPCOIN Core daemon:
