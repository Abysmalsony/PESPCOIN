...
This document provides guidelines for internationalization of the PESPCOIN Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `PESPCOIN_en.ts` remains unchanged.
